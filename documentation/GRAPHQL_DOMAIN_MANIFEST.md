...
| --- | --- | --- | --- | --- | --- |
| foundation | `src/graphql/base-schema.ts`<br>`src/graphql/data-completeness.ts` | `src/graphql/base-schema.ts` | _empty, __typename, __schema, __type | public | _empty=1, __typename=1, __schema=1, __type=1 |
| auth | `src/domains/auth/schema.ts` | `src/domains/auth/resolvers.ts` | me | public | me=1 |
| events | `src/domains/events/schema.ts` | `src/domains/events/resolvers.ts` | event, events, currentEventInfo, coreEventContext | public | event=1, events=1, currentEventInfo=5, coreEventContext=1 |
...
| players | `src/domains/players/schema.ts` | `src/domains/players/resolvers.ts` | player, players, playersForPicker, team, teams, topTransfersIn, topTransfersOut | public | player=1, players=1, playersForPicker=5, team=1, teams=5, topTransfersIn=1, topTransfersOut=1 |
...
| fixtures | `src/domains/fixtures/schema.ts` | `src/domains/fixtures/resolvers.ts` | fixtures, eventFixtures | public | fixtures=1, eventFixtures=5 |
| live | `src/domains/live/schema.ts` | `src/domains/live/resolvers.ts` | liveScores, playerLive, eventLive, eventLiveExplain, eventLiveExplains, liveSnapshot | public | liveScores=5, playerLive=1, eventLive=5, eventLiveExplain=1, eventLiveExplains=5, liveSnapshot=1 |
| live-desks | `src/domains/live-desks/schema.ts` | `src/domains/live-desks/resolvers.ts` | liveContext, liveMatchdayDesk, liveFixturePlayers, entryLiveCompetitionsDesk, entryLiveCompetitionBoard, tournamentSelectionIndex, tournamentEntrySquads, tournamentLiveParticipants | public, viewerEntryArg, viewerTournamentMember | liveContext=1, liveMatchdayDesk=1, liveFixturePlayers=1, entryLiveCompetitionsDesk=1, entryLiveCompetitionBoard=1, tournamentSelectionIndex=1, tournamentEntrySquads=1, tournamentLiveParticipants=1 |
| mini-program | `src/domains/mini-program/schema.ts` | `src/domains/mini-program/resolvers.ts` | miniProgramNotice | public | miniProgramNotice=5 |
| entry-live | `src/domains/entry-live/schema.ts` | `src/domains/entry-live/resolvers.ts` | entryLive, calcLivePointsByEntry, calcLivePointsForEntries | viewerEntryArg, public, calcOwnEntries | entryLive=1, calcLivePointsByEntry=10, calcLivePointsForEntries=10 |
| market | `src/domains/market/schema.ts` | `src/domains/market/resolvers.ts` | marketPulse, marketAvailabilityPage, marketLineup, marketOwnershipOverview, marketOwnershipDay, marketSnapshotContext | public | marketPulse=10, marketAvailabilityPage=5, marketLineup=1, marketOwnershipOverview=10, marketOwnershipDay=10, marketSnapshotContext=5 |
...
| trends | `src/domains/trends/schema.ts` | `src/domains/trends/resolvers.ts` | trendCohorts, trendCohortSnapshot | public, viewerEntry<br>conditional: trendCohorts: access=MINE -> viewerEntry, trendCohortSnapshot: access=MINE -> viewerEntry | trendCohorts=5, trendCohortSnapshot=10 |
