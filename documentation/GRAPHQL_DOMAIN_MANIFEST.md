...
| events | `src/domains/events/schema.ts` | `src/domains/events/resolvers.ts` | event, events, currentEventInfo, coreEventContext | public | event=1, events=1, currentEventInfo=1, coreEventContext=1 |
...
| players | `src/domains/players/schema.ts` | `src/domains/players/resolvers.ts` | player, players, playersForPicker, team, teams, topTransfersIn, topTransfersOut | public | player=1, players=1, playersForPicker=5, team=1, teams=2, topTransfersIn=1, topTransfersOut=1 |
