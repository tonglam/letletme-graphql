...
export const assertLiveTournamentAccessV2 = async (
	...
	if (hasPlatformAdminAccess(principal)) return;
	if (publicationMembership === true) return;
	if (publicationMembership === false) throw forbidden();
