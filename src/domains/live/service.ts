...
const withCalculatedTotalPoints = (
  ...
  totalPoints: calcElementLivePoints(elementType ?? 0, {
    ...live,
    bonus: bonusOverride ?? live.bonus,
  }),
});
...
export const liveService = {
  async getLiveScores(
    ...
    const performances = await liveRepository.getLiveScores(context, eventId, filter);
    return calculateTotalsForPerformances(context, performances, eventId);
  },
