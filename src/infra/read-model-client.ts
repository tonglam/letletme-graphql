...
const READ_MODEL_DEFINITIONS: Readonly<Record<ReadModel, ReadModelDefinition>> = {
	...
	[READ_MODELS.leagueEventResults]: {
		sourceRelations: ["competition.league_event_results", "competition.entries"],
		sql: `
			SELECT
				result.source_result_id AS id,
				result.league_id,
				...
				result.event_rank,
				result.event_chip,
				result.captain_element_id AS captain_id,
				result.captain_points,
				result.captain_blank,
				result.vice_captain_element_id AS vice_captain_id,
				result.vice_captain_points,
				result.vice_captain_blank,
				result.played_captain_element_id AS played_captain_id,
				result.highest_score_element_id,
				result.highest_score_points,
				result.highest_score_blank,
				result.source_checked_at
			FROM competition.league_event_results result
