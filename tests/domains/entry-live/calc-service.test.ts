...
describe('applyAutoSubs', () => {
  ...
  it('subjects bench player in for non-playing starter', () => {
    const picks = [
      ...
      // Bench
      makePick({ position: 12, elementType: 2, minutes: 90, multiplier: 0, totalPoints: 6 }),
  ...
  it('respects bench order (12 before 13)', () => {
    const picks = [
      ...
      makePick({ position: 10, elementType: 4, minutes: 90, multiplier: 1 }),
      makePick({ position: 11, elementType: 4, minutes: 90, multiplier: 1 }),
      makePick({ position: 12, elementType: 3, minutes: 90, multiplier: 0, totalPoints: 8 }), // MID bench
      makePick({ position: 13, elementType: 2, minutes: 90, multiplier: 0, totalPoints: 6 }), // DEF bench
    ];
    applyAutoSubs(picks, 'NONE');
