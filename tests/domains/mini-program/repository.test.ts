...
import { MINI_PROGRAM_NOTICE_REDIS_KEY, miniProgramRepository } from '../../../src/domains/mini-program/repository';
...
describe('miniProgramRepository.getMiniProgramNotice', () => {
  ...
  it('returns content when switch is ON', async () => {
    ...
    await expect(miniProgramRepository.getMiniProgramNotice(ctx)).resolves.toBe('Maintenance tonight');
  });
